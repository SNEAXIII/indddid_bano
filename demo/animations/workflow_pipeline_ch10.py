"""Chapitre 10 du workflow BANO : scoring et affichage Android."""
...
class Ch10Scoring(Slide):
    """Chapitre 10 — on classe les résultats : score + affichage sur Android."""

    def construct(self):
        title, sub = titled("On classe les résultats", "score", chapter=10)
        ...
        self.wait(0.6)
        self.next_slide()  # pause sur la requête fautive
        ...
        self.wait(1.2)
        self.next_slide()  # pause sur le détail du score (2.86)
        ...
        self.wait(2.5)
        self.next_slide()  # pause sur l'affichage Android final
