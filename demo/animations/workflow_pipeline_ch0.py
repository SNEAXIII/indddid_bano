"""Chapitre 0 du workflow BANO : vue d'ensemble."""
...
class Ch0Apercu(Slide):
    """Chapitre 0 — la vue d'ensemble : les grandes étapes en feuille de route."""
    ...
    def construct(self):
        ...
        self.wait(2.0)
        self.next_slide()  # pause sur la feuille de route complète
