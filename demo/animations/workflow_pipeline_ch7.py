"""Chapitre 7 du workflow BANO : le dictionnaire rangé en arbre (automate / FST).
...
class Ch7Fst(Scene):
    """Chapitre 7 — le dictionnaire trié est rangé en arbre de branches
    ...
    def construct(self):
        self.title, self.sub = titled(
            "Les mots rangés en arbre", "un automate fini — FST", chapter=7
        )
    ...
    def scene_recap(self):
        ...
        cap = (
            Text(
                "« rue » partagé — descendu une seule fois pour les deux mots",
                font_size=20,
                color=COL_SRC,
            )
