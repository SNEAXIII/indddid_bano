"""Chapitre 8 du workflow BANO : on emballe l'index en fichiers binaires."""
...
class Ch8Fichiers(Scene):
    """Chapitre 8 — l'index trié devient 3 fichiers livrés avec l'appli.
    ...
    def construct(self):
        title, sub = titled(
            "On emballe l'index", "les fichiers livrés avec l'appli", chapter=8
        )
