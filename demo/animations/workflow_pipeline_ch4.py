"""Chapitre 4 du workflow BANO : normalisation."""
...
class Ch4Normalisation(Scene):
    """Chapitre 4 — deux versions d'une adresse : la version affichée (gardée)
    et la clé normalisée (pour comparer). Elles coexistent."""

    def construct(self):
        title, sub = titled("Deux versions d'une adresse", "normalisation", chapter=4)
