"""Chapitre 6 du workflow BANO : index trie + postings."""
...
class Ch6Index(Scene):
    """Chapitre 6 — on range tout dans un index : dictionnaire trié + postings."""

    def construct(self):
        title, sub = titled(
            "On range tout dans un index", "index trié + listes d'adresses", chapter=6
        )
