...
class BANODatabaseBuilderNoJoinsRowid(BANODatabaseBuilder):
...
if __name__ == "__main__":
    db_cursor = DatabaseCursor("bano_no_joins_rowid.db")
    builder = BANODatabaseBuilderNoJoinsRowid(db_cursor)
