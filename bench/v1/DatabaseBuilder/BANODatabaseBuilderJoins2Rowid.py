...
class BANODatabaseBuilderJoins2Rowid(BANODatabaseBuilder):
        ...
        tables = {
            ...
            "adresses": """
                CREATE TABLE IF NOT EXISTS adresses (
                    ...
                    PRIMARY KEY (nom_voie, id_code_postal, id_nom_commune),
    ...
    def _process_csv_row(self, row, index):
        ...
        try:
            ...
            # Insérer l'adresse
            self.cursor.execute(
                "INSERT INTO adresses (nom_voie, id_code_postal, id_nom_commune) VALUES (?, ?, ?)",
                (nom_voie, id_code_postal, id_commune),
            )
            return 1
...
if __name__ == "__main__":
    db_cursor = DatabaseCursor("bano_joins2_rowid.db")
    builder = BANODatabaseBuilderJoins2Rowid(db_cursor)
