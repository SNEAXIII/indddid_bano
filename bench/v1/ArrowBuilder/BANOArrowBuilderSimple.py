...
from ArrowBuilder.Interface.BANOArrowBuilder import (
    BANOArrowBuilder,
    RowMalformedError,
)


class BANOArrowBuilderSimple(BANOArrowBuilder):
    """Builder pour un fichier Arrow IPC BANO simple avec les 3 colonnes principales."""

    def __init__(self, output_path="bano_simple.arrow"):
...
if __name__ == "__main__":
    builder = BANOArrowBuilderSimple("bano_simple.arrow")
